...
Verify the public repository's license display and CI, then use this repository URL in Devpost after owner review. The Devpost entry is not edited by repository setup. The September 11 Mac-local success report, original logs, and exact source have now been [reviewed and reconciled](verification_2026-09-11.md). Complete a public video under five minutes, required fields, and owner-confirmed final Submit; see [the current status](submission_readiness.md).
