...
| Demo video, max 5 minutes | CANDIDATE READY / PUBLIC URL MISSING | `ybca-submission-candidate.mp4`: English narration, Japanese-above-English captions, actual offline output and saved Mac results. Exact duration is pending final-file identification. Confirm the intended file is within five minutes, publish it, check anonymous playback, and register the URL. |
...
Reviewed file: `ybca-submission-candidate.mp4`, 1280 x 720. SHA-256: `c467f7495af012db70273e00ea42644c11f2836e8f9ef9b39cb955040db64fbf`. This file is prepared outside the source repository; no public video URL is available yet. The available file is within the five-minute limit, but its measured duration differs from the owner's stated final candidate. Exact duration remains on hold until the intended final file is identified; the video itself has not been changed. Original video checks covered full AV decoding, subtitle timing, 390/640-pixel visual review, and QR decoding. These checks do not establish physical-device playback or real-care benefit.
